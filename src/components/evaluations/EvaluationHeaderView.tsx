...
export function EvaluationHeaderView({ evaluation, onReload }: Props) {
    ...
    const [pdfLoading, setPdfLoading] = useState(false)  // ← NOUVEAU
            ...
            <CardHeader className="border-b border-gray-200 bg-gray-50 px-6 py-5">
                <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        {/* Bouton avancement état — existant */}
                        {evaluation.etat !== "CLO" && (
                            <Button
            ...
            <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                <DialogContent className="max-w-md">
                    ...
                    <DialogFooter>
                        ...
                        >
                            {evaluation.etat === "ELA" ? "Mettre à disposition" : "Clôturer"}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
            ...
            <CardContent className="p-0">
                ...
                <div className="px-6 py-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Field label="Année universitaire" value={evaluation.anneeUniversitaire} />
